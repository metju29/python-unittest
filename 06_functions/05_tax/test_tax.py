...
class TestCalcTax(unittest.TestCase):
    ...
    def test_calc_tax_incorrect_age_type_should_raise_error(self):
        self.assertRaises(TypeError, calc_tax, 6000, 0.2, '10')

    def test_calc_tax_negative_age_type_should_raise_error(self):
        self.assertRaises(ValueError, calc_tax, 6000, 0.2, -10)
